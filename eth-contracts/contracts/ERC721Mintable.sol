...
/* Ownable contract allows to own the contract */
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Null address not allowed as owner");
        _owner = newOwner;
        emit OwnershipTransferred(newOwner);
    }
}

/* Pausable contract allows to pause/resume the contract */
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(tokenOwner != to, "You send token to yourself");
        // require the msg sender to be the owner of the token or isApprovedForAll() to be true
        require(
    ...
    function _transferFrom(
        ...
        require(ownerOf(tokenId) == from, "You need to own the token to transfer it");
